...
__global__  void spgemmByAdaptiveWindow_4_16(const CSRMatrix* A, const CSRMatrix* B, CSRMatrix* C)
{
...
DELLEXPORT float spada_4_16(const bool isOne, const char* fileName, COOMatrix** h_coo_a, COOMatrix** h_coo_b, CSRMatrix** h_csr_c)
{
	...
	spgemmByAdaptiveWindow_4_16<<<dimGrid, dimBlock>>>(d_A, d_B, d_C);
